...
echo_and_run cd "/home/ubuntu/catkin_ws/src/dynamixel_motor/dynamixel_controllers"
...
echo_and_run /usr/bin/env \
    ...
    "/home/ubuntu/catkin_ws/src/dynamixel_motor/dynamixel_controllers/setup.py" \
     \
    build --build-base "/home/ubuntu/catkin_ws/build/dynamixel_motor/dynamixel_controllers" \
    install \
    --root="${DESTDIR-/}" \
